...
pub async fn create_question(
    ...
    match question {
        ...
        Err(err) => {
            ...
            error!("can not create the question due to err: {}",err);
...
pub async fn read_questions(
    ...
    match questions {
        ...
        Err(err) => {
            // TODO: log err using error! macro
            error!("can not read the questions due to err: {}",err);
            // todo!() // return a default internal error using the HandlerError type
            Err(HandlerError::default_internal_error())
        }
    }
...
pub async fn create_answer(
    ...
    match answer {
        ...
        Err(err) => {
            // TODO: log err using error! macro
            error!("can not create the answer due to err: {}",err);
            match err {
...
pub async fn read_answers(
    ...
    match answers {
        ...
        Err(err) => {
            // TODO: log err using error! macro
            error!("can not read the answers due to err: {}",err);
            // todo!() // return a default internal error using the HandlerError type
            Err(HandlerError::default_internal_error())
        }
    }
